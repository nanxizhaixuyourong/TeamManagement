...
function uploadimg()
{
pop("/massorganiza/js/uploadimg.jsp","上传图片",300,77)
}

function uploadimg2()
{
pop("/massorganiza/js/uploadimg2.jsp","上传图片",300,77)
}

function uploadimg3()
{
pop("/massorganiza/js/uploadimg3.jsp","上传图片",300,77)
}

function uploadimg4()
{
pop("/massorganiza/js/uploadimg4.jsp","上传图片",300,77)
}


function uploadimg5()
{
pop("/massorganiza/js/uploadimg5.jsp","上传图片",300,77)
}


function uploaddoc()
{
pop("/massorganiza/js/uploaddoc.jsp","docupload",300,77)
}

function uploaddoc2()
{
pop("/massorganiza/js/uploaddoc2.jsp","docupload",300,77)
}

function uploaddoc3()
{
pop("/massorganiza/js/uploaddoc3.jsp","docupload",300,77)
}
...
build:function(){
   ...
   var close='<img id="dialogBoxClose" title="关闭" src=/massorganiza/js/dialogclose.gif  />';
   ...
   if(this.config.contentType==1){var openIframe="<iframe width='100%' style='height:80px' name='"+this.iframeIdName+"' id='"+this.iframeIdName+"' src='"+this.info.contentUrl+"' frameborder='0' scrolling='"+this.config.scrollType+"'></iframe>";
