...
public class MainCtrl extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if(ac.equals("login"))
		{
		    ...
		    String sql1 = "select * from sysuser where uname='"+username+"' and status='通过' and upass='"+password+"' ";
			...
			if(userlist.size()!=1)
			{
				...
				gor("/massorganiza/admin/index.jsp", request, response);
			}
			}	
		 }
		...
		if(ac.equals("flogin"))
		{
			...
			if(userlist.size()!=1)
			{
				...
				request.getSession(). setAttribute("admin", userlist.get(0));
				gor("/massorganiza/index.jsp", request, response);
			}
			}	
		 }
		...
		if(ac.equals("uppass"))
		{
			...
			dao.commOper(sql);
			gor("/massorganiza/admin/uppass.jsp", request, response);
		}
		...
		if(ac.equals("upmpass"))
		{
			...
			System.out.println(sql);
			dao.commOper(sql);
			gor("/massorganiza/admin/upmpass.jsp", request, response);
		}
		...
		if(ac.equals("addylzx"))
		{
			...
			String filename = request.getParameter("filename"); 
			String content = request.getParameter("content"); 
			String sql = "insert into mixinfo values(null,'"+title+"','"+filename+"','"+content+"','"+author+"','"+source+"','','','最新活动','"+date+"')";
			request.setAttribute("suc", "");
			dao.commOper(sql);
